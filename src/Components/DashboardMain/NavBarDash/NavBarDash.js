    ...
    <div className="NavBar shadow">
      <div className={`container ${props.noContainer} `}>
        <div className="Nav">
          ...
          <div className="links links-dash">
            ...
            <ul className="ul-links">
              ...
              <li>
                <Link
                  to="/MyProfile"
                  href="#"
                  className={`anchor anchor-img hover-red transition`}
                >
                  <img src="image/Review/testimonial-3.png" />
                  <span>Salim Aldosery</span>
                </Link>
              </li>
              <li>
                <Link to="Login" className={`anchor`}>
                  <i className="fa fa-sign-out signOut"></i>Logout
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="login login-dash">
            <Link
              to="/AddListing"
              href="#"
